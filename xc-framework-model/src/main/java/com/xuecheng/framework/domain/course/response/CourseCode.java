...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false, 31006, "创建课程索引信息失败！"),
    COURSE_MEDIS_URLISNULL(false, 31101, "选择的媒资文件访问地址为空！"),
    COURSE_MEDIS_NAMEISNULL(false, 31102, "选择的媒资文件名称为空！"),
    COURSE_FIND_COURSENOTEXIST(false, 31201, "课程不存在！"),
    COURSE_FIND_COURSMARKETENOTEXIST(false, 31201, "课程不存在！");
